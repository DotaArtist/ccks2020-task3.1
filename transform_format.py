...
if __name__ == '__main__':
    ...
    transform_crf_platform(crf_path='task1_unlabeled_predict.txt', platform_path='submit3.json')

    transform_platform_train(platform_path='submit3.json', train_path='submit3.txt')
